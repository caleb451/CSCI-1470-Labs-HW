...
int main()
{
	...
	// Use a char variable to store if the user chooses to ask another 
	// question. Initialize it to 'y' so that the loop will execute
	// at least once.
	char askAgain = 'y'; // If the user wants to ask another question
	...
	while (askAgain == 'y')
	{
		...
		cin >> askAgain;
		cin.ignore(5000, '\n');		// need this to remove the remaining new line character ('\n') from cin
	}
